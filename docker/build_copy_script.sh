...
BLD_BASE_DIR=/build/VulkanSamples/API-Samples/android
BLD_DIR=build/outputs/apk/debug
TGT_DIR=/build/VulkanSamples/docker/BUILD_APKs

export ANDROID_SDK_ROOT=/build/VulkanSamples/docker/Sdk/
